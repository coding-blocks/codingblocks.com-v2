        ...
        <div class="width-limiter">
          <div class="row align-items-center">
            <div class="col-6 d-md-block d-none">
              <img
                src="https://i-invdn-com.akamaized.net/akapi-images/800x450/89699ff8b0f2d7706e5ff7b9cea439e9_w_800_h_450.jpg"
                class="w-90"
              />
            </div>
            <div class="col-md-6">
              <div class="heading-6 mb-15">WORKSHOP</div>
              <div class="heading-1 mb-10">Machine Learning</div>
              <div class="row no-gutters align-items-center">
                <img
                  src="https://cb-thumbnails.s3.ap-south-1.amazonaws.com/orange-disc.svg"
                />
                <div class="heading-5 orange bold flex-1 pl-15">
                  Registration Closes on 20th July
                </div>
              </div>
              <img
                src="https://i-invdn-com.akamaized.net/akapi-images/800x450/89699ff8b0f2d7706e5ff7b9cea439e9_w_800_h_450.jpg"
                class="d-md-none d-block my-30"
              />
        ...
        <div class="width-limiter">
          <div class="row">
            <div class="col-md-6 mb-md-none mb-40 pr-md-60">
              <div class="heading-4 mb-md-50 mb-30 bold">
                About the Workshop
              </div>
              <div class="font-4 t-align-j">
                ...
                without knowing it. Many researchers also think it is the best
                way to make progress towards human-level AI. In this class, you
                will learn about the most effective machine learning techniques,
                and gain practice implementing them and...more
              </div>
            </div>
            <div class="col-md-6">
