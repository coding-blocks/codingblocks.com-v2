  ...
  <div class="landing-page__section">
    <div class="row no-gutters justify-content-between align-items-center">
      <div class="flex-1">
        ...
        <div class="heading-font">FROM THE BLOG</div>
        <img
          ...
          <div class="mt-2 w-100">
            ...
            <div class="mt-3">
              <div class="heading-6 text-clamp-ellipses text-clamp-ellipses--2">
                Something just like this is hampering my head space and fucking
                up! Something just like this is hampering my head space and
                fucking up! Something just like this is hampering my head space
                and fucking up! Something just like this is hampering my head
                space and fucking up!
              </div>
            </div>
