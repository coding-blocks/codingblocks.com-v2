                ...
                <div class="row align-items-center mt-xl-5 mt-4">
                  <div class="col-xl-6 col-12 mb-xl-0 mb-4">
                    <div class="row no-gutters align-items-center">
                      <div>
                        <img
                          src="https://minio.codingblocks.com/amoeba/1258c47b-f95d-4a71-a2ce-b87ced5e5ae2.png"
                          alt="COURSE Logo"
                          class="s-60x60 br-50"
                        />
                      </div>
                  ...
                  <div class="col-xl-3 col-6">
                    ...
                    <div class="normal">
                      <strong>4.71/5.0</strong>, 371 Ratings
                    </div>
                  </div>
                  <div class="col-xl-3 col-6">
                    <div
              ...
              <div class="pl-lg-5 pl-md-4 pl-sm-5 pl-4 pt-5 position-relative">
                ...
                <div class="row align-items-center mt-xl-5 mt-4">
                  ...
                  <div class="col-xl-3 col-6">
                    ...
                    <div class="normal">
                      <strong>4.57/5.0</strong>, 714 Ratings
                    </div>
                  </div>
                  <div class="col-xl-3 col-6">
                    <div
              ...
              <div class="pl-lg-5 pl-md-4 pl-sm-5 pl-4 pt-5 position-relative">
                ...
                <div class="row align-items-center mt-xl-5 mt-4">
                  ...
                  <div class="col-xl-3 col-6">
                    ...
                    <div class="normal">
                      <strong>4.72/5.0</strong>, 53 Ratings
                    </div>
                  </div>
                  <div class="col-xl-3 col-6">
                    <div
              ...
              <div class="pl-lg-5 pl-md-4 pl-sm-5 pl-4 pt-5 position-relative">
                ...
                <div class="row align-items-center mt-xl-5 mt-4">
                  ...
                  <div class="col-xl-3 col-6">
                    ...
                    <div class="normal">
                      <strong>4.57/5.0</strong>, 114 Ratings
                    </div>
                  </div>
                  <div class="col-xl-3 col-6">
                    <div
              ...
              <div class="px-5 pt-5 position-relative">
                ...
                <div class="row no-gutters align-items-center mb-5">
                  <div class="col-md-2 t-align-md-l t-align-c">
                    <img
                      src="https://minio.codingblocks.com/amoeba/badge-orange.svg"
                    />
                  </div>
                  <div class="col-md-10 t-align-md-l t-align-c">
                    ...
                    <div>
                      At the end of the track, you will be job ready and can
