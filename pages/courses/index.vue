            ...
            <div class="py-sm-50 py-30" style="border-top: solid 1px #dddddd;">
              <div class="">
                <div class="row">
                  ...
                  >
                    <div
                      class="row justify-content-between mb-50 no-gutters w-100"
                    >
                      <div
                        class="heading-5 bold col-md-7 col-12 mb-sm-none mb-20"
                      >
                        ... & I want to become a
                      </div>
                    ...
                    <div class="row">
                      <div class="col-md-3 col-sm-4 col-6 h-inherit mb-40">
                        <div
                          class="option-div option-div--square selected h-100"
                        >
                          <div>
                            <img
